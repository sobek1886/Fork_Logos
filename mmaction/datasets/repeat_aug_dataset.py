...
class RepeatAugDataset(VideoDataset):
    ...
    def __init__(self,
        ...
        use_decord = get_type(pipeline[0]) in ('DecordInit', 'Hdf5VideoInit') and \
               get_type(pipeline[2]) in ('DecordDecode', 'Hdf5VideoDecode')  # Hdf5VideoInit is similar to DecordInit
