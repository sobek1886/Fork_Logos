...
from .mvit_reg_head import MViTRegHead
...
__all__ = [
    'BaseHead', 'GCNHead', 'I3DHead', 'MViTHead', 'MViTRegHead', 'OmniHead', 'SlowFastHead',
    'TPNHead', 'TRNHead', 'TSMHead', 'TSNAudioHead', 'TSNHead',
    'TimeSformerHead', 'UniFormerHead', 'RGBPoseHead', 'GateHead', 'X3DHead', 'FeatureHead'
]
