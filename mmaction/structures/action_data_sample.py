...
class ActionDataSample(BaseDataElement):
    ...
    def __init__(self, *kargs, **kwargs):
        ...
        self.set_field(None, '_dataset_key')
    ...
    @property
    def gt_boundaries(self):
        """Property of `gt_boundaries`"""
        return self._gt_boundaries

    @gt_boundaries.setter
    def gt_boundaries(self, value):
        """Setter of `gt_boundaries`"""
        self.set_field(value, '_gt_boundaries', dtype=torch.Tensor)

    @gt_boundaries.deleter
    def gt_boundaries(self):
        """Deleter of `gt_boundaries`"""
        del self._gt_boundaries
